...
JSIL.ImplementExternals("Microsoft.Xna.Framework.Graphics.SpriteBatch", function ($) {
  ...
  $.Method({Static:false, Public:true }, "Begin",
    ...
    (new JSIL.MethodSignature(null, [
      $xnaasms.xnaGraphics.TypeRef("Microsoft.Xna.Framework.Graphics.SpriteSortMode"),
      $xnaasms.xnaGraphics.TypeRef("Microsoft.Xna.Framework.Graphics.BlendState"),
      $xnaasms.xnaGraphics.TypeRef("Microsoft.Xna.Framework.Graphics.SamplerState"),
      $xnaasms.xnaGraphics.TypeRef("Microsoft.Xna.Framework.Graphics.DepthStencilState"),
      $xnaasms.xnaGraphics.TypeRef("Microsoft.Xna.Framework.Graphics.RasterizerState"),
    ], [])),
  ...
  function Draw9(texture, position, sourceRectangle, color, rotation, origin, scale, effects, layerDepth) {
    var sourceX = 0, sourceY = 0, sourceWidth = 0, sourceHeight = 0;
    if (sourceRectangle !== null) {
      sourceX = sourceRectangle.X;
      sourceY = sourceRectangle.Y;
  ...
  $.Method({Static:false, Public:true }, "Draw",
    (new JSIL.MethodSignature(null, [
          ...
          $.Single
        ], [])), function(texture, position, sourceRectangle, color, rotation, origin, scale, effects, layerDepth) {
          Draw9.call(this, texture, position, sourceRectangle, color, rotation, origin, scale, effects, layerDepth);
        },
  );
