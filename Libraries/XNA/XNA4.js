...
$jsilxna.Color = function ($) {
  ...
  ["get_SandyBrown", "get_DarkKhaki", "get_MediumAquamarine", "get_Beige", "get_White", "get_CornflowerBlue", "get_Black", "get_Red", "get_Cyan", "get_Lime", "get_Violet"].forEach(mm => {
    $.Method({
      Static: true,
      Public: true
    }, mm, new JSIL.MethodSignature($jsilxna.colorRef(), [], []),
